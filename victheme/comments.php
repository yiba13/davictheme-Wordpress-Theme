...
<div id="comments" class="comments-area">
   ...
   <?php 
    ...
    // 添加评论内容的文本域表单元素
  	'comment_field'         => '<p class="comment-form-comment"><textarea id="comment" name="comment" cols="45" rows="5" placeholder="要不说点什么..." aria-describedby="form-allowed-tags" aria-required="true" required="required"></textarea><span id="smilies">
